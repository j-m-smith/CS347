...
--   at:        2015-02-16 18:02:01 GMT-06:00
...
DROP TABLE SIM_assignment CASCADE CONSTRAINTS ;
...
CREATE TABLE SIM_assignment
  (
    assignment_id          INTEGER NOT NULL ,
    SIM_Person_person_id   INTEGER ,
    SIM_project_project_id INTEGER
  ) ;
ALTER TABLE SIM_assignment ADD CONSTRAINT SIM_assignment_PK PRIMARY KEY ( assignment_id ) ;
...
ALTER TABLE SIM_assignment ADD CONSTRAINT SIM_assignment_SIM_Person_FK FOREIGN KEY ( SIM_Person_person_id ) REFERENCES SIM_Person ( person_id ) ;

ALTER TABLE SIM_assignment ADD CONSTRAINT SIM_assignment_SIM_project_FK FOREIGN KEY ( SIM_project_project_id ) REFERENCES SIM_project ( project_id ) ;
